...
import pandas as pd
from modules.visual_comparision import TableEvaluator
import os
import numpy as np
...
class GAN():
    ...
    def __init__(self, name, model_save_path, gan_args):
    ...
    def train(self, data, train_arguments):
        ...
        for epoch in range(epochs):
            ...
            if epoch % sample_interval == 0:
                ...
                model_checkpoint_base_name = self.model_save_path + "/" + self.name + '/' + cache_prefix + '_{}_model_weights_step_{}.h5'
...
# Define the GAN model and training parameters using a batch size of 32 and train it for 2000 epochs.
    noise_dim = noise_dim
    dim = 128
    ...
    # training the model and see how much the model is able to learn from real deataset.
    model = GAN

    # Training the GAN model chosen: Vanilla GAN, CGAN, DCGAN, etc.
    os.makedirs(model_save_path + "/" + name, exist_ok=True)
    synthesizer = model(name, model_save_path, gan_args)
